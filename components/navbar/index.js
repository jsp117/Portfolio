...
export default function Nav({ page, newPage }) {
    const selected = "border-indigo-500 text-gray-900 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium";
    const unselected = "border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium";
        ...
        <nav className="bg-white shadow">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between h-16">
                    <div className="flex">
                        {/* Img, or site title goes here */}
                        {/* <div className="flex-shrink-0 flex items-center">
                            <div className="lg:block h-6 w-auto">JSP</div>
                        </div> */}
                        <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
                            {page == "/" ? <>
                                <span className={selected} onClick={() => newPage("/")}>
                                    Home
                            </span>
                                <span className={unselected} onClick={() => newPage('/projects')}>
                                    All Projects
                            </span> </> : <>
                                <span className={unselected} onClick={() => newPage("/")}>
                                    Home
                            </span>
                                <span className={selected} onClick={() => newPage('/projects')}>
                                    All Projects
                            </span>
                            </>}
                ...
                <div className="pt-4 pb-3 border-t border-gray-200">
                    <div className="flex items-center px-4">
                        <div className="flex-shrink-0">
                            <img className="h-10 w-10 rounded-full" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixqx=D7GcfD3Tja&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt=""></img>
                        </div>
                        <div className="ml-3">
